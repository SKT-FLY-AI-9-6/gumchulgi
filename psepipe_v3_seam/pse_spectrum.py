...
# 통합(2026-08-14): pse_analyze(4채널 대립축, legacy_detectors/) 의존을 끊고
# 같은 폴더의 규격 판정기에서 동일 상수·함수를 가져온다. 값은 두 파일이 같다
# (SDR_PEAK 200 / BT.1886 EOTF 2.4).
from pse_bt1702 import SDR_PEAK, decode_linear
